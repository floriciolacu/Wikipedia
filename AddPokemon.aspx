<%@ Page Title="Add" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddPokemon.aspx.cs" Inherits="AddPokemon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div style="padding: 10px">
        <asp:Button ID="AddButton" runat="server" Text="Add New Pokemon" OnClick="AddButton_Click" />
    </div>
    <div style="padding: 10px">
